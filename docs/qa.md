...
???+ general "A"
    ...
    校园网套餐分 10、20、50 元包月三种，区别在于带宽，个人认为 10 元足够。另外，不建议使用网线上网，浙大的有线网络更不稳定，而且需要占用电脑的 VPN，导致无法使用其它代理。建议大家在开学后需要校网时开通，因为是从开通起计算日期，提前开通相当于做慈善（除非你想要提前使用浙大的正版软件）。办学校杭州电信与移动的电话卡可以升级校网服务（花 10 元能用 30 元校网，花 30 元用 50 元校网，具体请持身份证到营业厅办理，营业厅会定期统一报给信息中心）。
...
???+ general "A"
    今年图灵班的招生计划数为 60+ 人，但由于部分省份的招生人数会超出计划数，导致人数一般不止如此（像 23 级计划为 81 人，但是实际达到了 104 人）。今年由于图灵班只有CS一个专业方向，招生人数应该会有所减少，但具体数字暂时未知，名单还需等待。所有同学会分到三个班，在省份平均原则基础上随机分班。教室方面，图灵没有所谓的专用教室，上课教室都是根据自己所选课程所在教室决定。不过在大家升入大三搬到玉泉校区后可以使用图灵专教。
