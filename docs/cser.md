...
!!! abstract "前言"
    ...
    博客原文链接：[如何让自己看上去、闻起来都像一个CS人](https://hobbitqia.github.io/p/5948019b.html)
...
什么是版本控制？版本控制是一种记录一个或若干文件内容变化，以便将来查阅特定版本修订情况的系统。即保存你每次修改后的文件版本。
而我们刚刚所说的 GitHub 就需要 Git 来进行代码的上传下载
