...
![](https://turing2025.tonycrane.cc/images/video_output.png)
...
> [!tip] 锐龙 AI 400 / 300 系列只出现在 轻薄本（H/HS 标压） 上，而桌面端或游戏本标着"Ryzen 9"的 U 是 Ryzen 9000 HX 系列，两者是完全不同的两条产品线，不要搞混。
...
> 
> - **AMD 锐龙 AI 400 系列**：今年 CES 刚发布的新移动旗舰（AI 9 HX 475 / AI 9 465 / AI 7 450 / AI 5 430 等），本质是锐龙 AI 300 的提频升级版，仍为 Zen5 CPU + RDNA 3.5 核显 + XDNA2 NPU（算力提到 60 TOPS，但对你的学习还是没啥用）。搭载机型今年上半年才陆续上市，溢价不低，且提升不大（同频同架构仅提升 $2\%$ ~ $5\%$）；
>     
...
> - OLED 屏幕长期显示固定界面（任务栏、菜单等）可能存在残影/烧屏风险，建议开启隐藏任务栏 + 动态壁纸 + 像素偏移（Windows 默认开启）来延长寿命。对静态文字办公多的同学，高素质 LCD/IPS 机型可能更省心。
...
#### 「联想」ThinkBook 14 2025 清仓版
|项目|参数说明|
|---|---|
|处理器|Ultra 5 225H / R7 H255 处理器|
|内存|16GB / 32GB DDR5 5600MHz（双插槽可换）|
|硬盘|512GB / 1TB PCIe 4.0 固态（双 M.2 盘位）|
|屏幕|14 英寸，2880×1800，100%sRGB，120Hz，IPS |
|电池容量|60Wh|
|整机重量|1.46kg|

参考到手价	R7 H255 + 16G + 512G 约 4900；Ultra 5 225H + 32G + 1T 约 6700（属下一档）

[!success] 优势：内存硬盘双可换，接口齐全，ThinkBook 家族售后和模具口碑扎实

[!failure] 劣势：清仓库存波动大，容易断货；2242 硬盘规格后续更换选择少

如果你接受"买去年的款式"这个策略，这是 5000 以内综合素质最均衡的 14 寸之一。R7 H255（=8845HS 马甲）的 780M 核显日常 + 轻度游戏完全够用，16G 内存后期嫌少可以自己换——这反而是今年新平台 LPCAMM2 或板载机型做不到的。不过清仓库存卖一台少一台，看到合适价格不用犹豫太久。

#### 「惠普」战66 八代锐龙版
|项目|参数说明|
|---|---|
|处理器|R7 H255 处理器（8C/16T，Zen4，Radeon 780M）|
|内存|24GB / 32GB DDR5（双插槽可换）|
|硬盘|1TB PCIe 4.0 固态（双 M.2 盘位）|
|屏幕|14 英寸 / 16 英寸，2560×1600，100% AdobeRGB / DCI-P3 / sRGB，120Hz，400nit，IPS|
|整机重量|1.40kg（14"）/ 1.76kg（16"）|

参考到手价	14" 24G+1T 约 4300～4500（国补后）；16" 同配约 4760

[!success] 优势：5000 以内极少数给到 24G 内存 + 双盘位的机型，屏幕色域覆盖极全（三覆盖），1 年上门售后

[!failure] 劣势：R7 H255 是老架构马甲，模具质感不如 ThinkBook，低配 1200P 屏版不建议

今年清仓涨价潮里的一股清流：R7 H255（Zen4 马甲）性能不过时，24G+1T 的搭配恰好卡在"够用不丐"的甜点上，双插槽 + 双盘位让后期仍有升级余地。4300~4500 的价位段里基本没有对手，适合预算敏感但不想在核心体验上妥协的同学。注意避开低配的 1200P 60Hz 屏幕版，2.5K 120Hz 屏才是这个价位的精髓。
...
> [!success] 优势：大电池，续航长，接口多

> [!failure] 劣势：处理器架构较老，且重量算不上轻
...
|项目|参数说明|
|---|---|
|**处理器**|AI 7 H350 / AI 9 H465|
|**显卡**|RTX 5060 独立显卡 (110W)|
|**内存**|32GB LPDDR5x 内存 7500MT/s|
|**硬盘**|1TB 固态硬盘|
|**屏幕**|14 英寸，2560×1600 分辨率，165Hz，IPS|

> [!success] 优势：同尺寸下性能释放强，散热优良，续航良好，重量相对较轻 ($1.47\text{kg}$)

> [!failure] 劣势：第二个 M.2 硬盘貌似只支持 PCIe 4.0 ×2

2026 款国补参考价在 7700 起，相比之下 2025 款性价比更高，毕竟只更新了 CPU，且大概率上也只多一个 AI 马甲。
