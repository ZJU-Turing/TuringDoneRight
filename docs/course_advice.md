...
2. 自学更为重要
    ...
    - 善于使用 AI 工具，不要害怕使用 AI，也不要过于依赖 AI 而失去了自己的思考。你可以使用 AI 去辅助你完成一些水课的作业、论文，可以与 AI 对话来解决你在课堂上遇到的困惑，可以让 AI 为你探索新领域提供指导。但是，不要让 AI 代替你去完成所有作业，比如直接使用AI生成代码、把作业直接拍给 AI 然后抄答案、直接使用 Agent 生成实验报告并直接提交，这不能让你获取任何知识与思考，只会让你有学会了很多东西的错觉。
3. 大学考试周压力更大
...
2. 课程会限制优秀率
    ...
    - 不过，截至 2026 年，实际上只对通识课限制较大，因为在教务网提交学生成绩时，通识课优秀率超过  30% 不允许提交，而专业课仅是警告，带 H 的荣誉课则无此限制
3. 浙江大学学习较为自由
...
4. 学会获得历年卷
    ...
    - cc98 论坛上也有很多历年卷，请善用搜索，一个 tag 搜不到时，尝试更换简称或其他近义词
...
由于培养方案的改动，可能会有一些课程的安排有所不同，并且大家现在看到的培养方案也不是最终版，教学科会经常撤下来做一些修改，因此请大家根据自己最终的培养方案进行查看。
...
- 大学生思想文化素养
!!! note "注意"
    由于培养方案的改革，以下三门思政类课程已不在目前的[ 26 级培养方案](assets/26图灵培养方案.pdf)中，仅作为新课程 大学生思想文化素养 的学习参考。
...
- [计算机系统 Ⅰ ](https://zju-turing.github.io/TuringCourses/major/computer_system1/)
...
在[ 26 级培养方案](assets/26图灵培养方案.pdf)中，外语类课程实行阶梯式学分修读要求，根据学生英语能力（主要是根据入学英语测试）由低到高划分为 L1、L2、L3 三个层次：
!!! note "英语层次划分"
    === "L1"
        应修满6学分 包含:

        - 必修课程：大学英语 IV  
        - 限选课程：在“英语进阶课程”“英语发展课程”“英语高阶课程”三个模块中选择修读，其他模块课程学分不计入外语类。
    === "L2"
        应修满3学分 包含: 
