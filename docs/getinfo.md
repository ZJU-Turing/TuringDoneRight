...
!!! abstract
    亲爱的学弟学妹们你们好 QwQ！本篇文档将分享一些学长们高效搜集信息的方法和渠道 and 一些常用的校内网站、小程序。这些知识将帮助大家能够自力更生而非总是麻烦他人地去了解学校最新通知、获得新知识（~~大不了自己多学一点~~），使大家不至于错过重要的活动或通知，有许多学习方面的知识与技术也是课上不教（~~或者教的很烂~~）需要自己学习的，希望能给大家带来帮助 q(≧▽≦q)
...
如何利用已知信息进行搜索也是个很重要的能力，一般搜索分为三步：准确描述自己想要的搜索目标（将口语化的表述转化成几个关键词进行搜索）；准确找到垂直搜索渠道，发现更多同类型网站；掌握高级搜索指令（也就是上面提到的advanced search）
...
### 使用大语言模型
2023 年 ChatGPT 的火热程度想必大家都有所耳闻，作为 2023 年的大学生，~~你的水课作业将一定会多多少少的用到它~~，很多专业上的知识甚至是代码问题都可以向大语言模型请教（~~当然不排除它会瞎编的可能性~~）。目前比较流行的大语言模型有 ChatGPT、New Bing、Google Bard、文心一言、通义大模型等等。目前都是可以免费注册使用的，各别可能需要排队申请名额，每个模型没有太大的差别，需要你自己探索~
...
更多关于ChatGPT的介绍推荐大家可以来看98的这条帖子：[墙内最强 AI 教学：一文玩转 ChatGPT](https://www.cc98.org/topic/5580901)

**注意，大语言模型只是辅助大家更便利获取知识的工具，一定不要过度依赖，更一定不要将它创作的内容直接复制粘贴成为自己的作业、论文！**现在已经出现了不少识别 AI 创作内容的工具，如果被老师发现你的作业是用 ChatGPT 写的，想必后果可想而知

### 图灵班学习指南网站
今年你们的学长学姐（包括学爷学祖）们新建立了一个项目网站[图灵班学习指南](https://zju-turing.github.io/TuringCourses/)，上面收集了同学们学习各种通识课、专业课等等课程的经验与建议，大部分大一的基础课程已经有了较为完善的内容，而且还有书评专区等等，同学们如果想了解各种课程的信息可以尝试在这里寻找答案

此外，这个网站仍在发展建设之中，欢迎同学们在未来参与到网站的建设中~（贡献指南也在网站里）
...
* **浙大生活**：生活服务功能中集合了自习空间（包括自习教室空余的实时查看、图书馆自习位置以及蒙民伟自习空间的预约等功能），网上订餐（也就是~~味同嚼蜡的~~学霸餐），小白车、宝宝巴士位置的查看，校园地图等功能，可以说校园内的生活服务都在这里
...
在这里，你可以交流任何问题，可以找到各种学习资源，可以找到留学、找工作等经验分享,可以看到帅气 xgg 漂亮 xjj，可以看到各种令人震撼的心灵故事，~~还可以在这里找到属于自己的缘分~~
