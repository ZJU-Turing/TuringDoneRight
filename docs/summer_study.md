...
!!! Warning "注意"
    虽然 AI 工具很好用，能让你做到远超自己能力边界的事。但这并不意味着 AI 工具可以替代基础知识的学习。在学习课程阶段，我们应该掌握好使用 AI 的边界，不应过度依赖 AI。一个简单的判断标准是，你不应该用 AI 完成那些需要你掌握（未来会用到）而你目前还未掌握的工作。比如，正确的做法是，跟 AI 进行多轮询问以弄清原理，或者让 AI 生成学习/复习资料，或者用 AI 完成一些意义不大的工作（比如某些通识课作业）；错误的做法是，让 AI 直接生成完整作业答案或者编写代码。图灵 25 学长组已经吃过这个亏了（笑）。
