...
!!! Info "In-Progress"
    文章有待审核。以及下面[对 Q&A 的引用](/checkin/#_6)需要相应页面完成后更新。
...
在 8 月 10 日到 18 日期间，可以登录“学在浙大” [course.zju.edu.cn](https://course.zju.edu.cn/) 进入“新生养成教育 MOOC”课程进行学习。
...
使用“统一身份认证”登录“学在浙大” [course.zju.edu.cn](http://course.zju.edu.cn/) 搜索“大学计算机先修课”，学习有关计算机使用及编程的基础知识。建议大家认真学习相关内容，之前对计算机和编程了解比较少的同学也可以趁此机会进行计算机的入门，为之后的课程打个基础。（~~虽然不知道测试成绩会如何影响之后的学习，但考试时什么都不会总是打击信心~~）
...
新生第一轮选课在 8 月 21 日 9:00 到 23 日 17:00 进行，~~形式为彩票开奖，所以不用抢课~~，不用着急，到时候学长组会有线下手把手指导，也会有提醒，网站里也有较详细的选课指南，目前暂未公布～建议**认真阅读 Turing Course**，否则可能会选到事多分少的课程。
